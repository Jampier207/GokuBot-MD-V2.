...
export default {
  ...
  run: async (client, m, args, command, text, prefix) => {
    ...
    if (ranking.length === 0)
      return m.reply(`卍 No hay actividad registrada en los últimos 30 días.`)
    ...
    if (page < 1 || page > totalPages)
      return m.reply(`卍 Página inválida. Solo hay ${totalPages} páginas disponibles.`)
    ...
    let report = `卍 Top de mensajes en los últimos *30* días\n\n`
