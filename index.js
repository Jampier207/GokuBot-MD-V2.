...
const displayLoadingMessage = () => {
  console.log(chalk.bold.redBright(`\n\nPor favor, Ingrese el número de WhatsApp.\n` +
      `${chalk.bold.yellowBright("Ejemplo: +5939********")}\n` +
...
const opcion = askQuestion.question(
  chalk.magentaBright(`
╔══════════════════════════════════════╗
║                                      ║
║        ✨ G O K U B O T - M D ✨       ║
...
╠══════════════════════════════════════╣
║                                      ║
║   ${chalk.cyanBright("Selecciona método de vinculación")}       ║
║                                      ║
║   ${chalk.greenBright("1 → Código QR")}                          ║
║   ${chalk.yellowBright("2 → Código de 8 dígitos")}               ║
║                                      ║
╚══════════════════════════════════════╝
`)
